		...
		<ul class="layui-nav layui-nav-tree layui-nav-side" lay-filter="test">
		  <li class="layui-nav-item layui-nav-itemed">
		    ...
		    <dl class="layui-nav-child">
		      <dd><a href="javascript:;" data-type="tabAdd" data-id="" data-url="<?php echo U(GROUP_NAME.'/Blog/addBlog');?>">博文列表</a></dd>
		  ...
		  <li class="layui-nav-item">
		    ...
		    <dl class="layui-nav-child">
		      <dd><a href="javascript:;" data-type="tabAdd" data-id="" data-url="<?php echo U(GROUP_NAME.'/Attribute/index');?>">属性列表</a></dd>
		      <dd><a href="javascript:;" data-type="tabAdd" data-id="" data-url="<?php echo U(GROUP_NAME.'/Attribute/addAttr');?>">添加属性</a></dd>
		    </dl>
		  </li>
		  <li class="layui-nav-item">
		  ...
		  <li class="layui-nav-item"><a href="<?php echo U(GROUP_NAME.'/Blog/upload');?>">上传图片练习</a></li>
		</ul>
	</section>
